...
// const AudioCall = require("./models/audioCall.JS");
...
const io = new Server(server, {
  cors: {
    origin: ["https://chirpskykite-frontend.onrender.com", "https://chirpskykite-server.onrender.com"],
    methods: ["GET", "POST"],
  },
});
...
io.on("connection", async (socket) => {
  ...
  socket.on("start_conversation", async (data) => {
    ...
    // if not => create a new OneToOneMessage doc & emit event "start_chat" & send conversation details as payload
  ...
  socket.on("text_message", async (data) => {
    ...
    // create a new conversation 'if' it doesn't yet exist or add new message to the msg list
